...
from .memory import memory_add, memory_delete, memory_get, memory_list, memory_search
    ...
    *,
    ...
    tools: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "function": {
                "name": "memory_list",
                "description": "List memory notes (pinned first, then most recently updated) with ids/keys for retrieval.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        ...
                        "max_content_chars": {"type": "integer", "minimum": 40, "maximum": 4000, "default": 240},
                    },
                },
            },
        },
...
_TOOL_DISPATCHERS: dict[str, Callable[[ToolContext, dict[str, Any]], dict[str, Any]]] = {
    ...
    "memory_list": lambda ctx, args: memory_list(
        ctx,
        limit=int(args.get("limit", 20)),
        offset=int(args.get("offset", 0)),
        include_expired=bool(args.get("include_expired", False)),
        include_content=bool(args.get("include_content", False)),
        max_content_chars=int(args.get("max_content_chars", 240)),
    ),
